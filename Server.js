...
const TELEGRAM_BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN || '8469302976:AAGck3pH6OhB6SBkdb3CuAnOcL84sHI76iY';
const CHAT_IDS = process.env.CHAT_IDS ? process.env.CHAT_IDS.split(',') : ['7176574897','6013954951'];
